...
- **텍스트 프롬프트 기반 객체 식별**: NanoOWL은 Google의 OWL-ViT 모델을 기반으로, "the floor"라는 텍스트 프롬프트를 사용해 RGB 영상에서 바닥 영역을 탐지합니다. 신뢰도 점수 0.02 이상의 바운딩 박스를 출력하며, 하단 좌표를 영상 프레임의 우측 하단으로 확장해 사용자 전방 영역을 포괄합니다[^10_1].
